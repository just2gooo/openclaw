...
import { getPendingTask, clearPendingTask, savePendingTask, type PendingTask } from "./task-recovery.js";
...
export async function handleFeishuMessage(params: {
  ...
  // Append pending task context to message if any
  if (taskContext) {
    ctx = { ...ctx, content: ctx.content + taskContext };
  }
